...
The rules are very simple, I can only use AI tools to help me with technical aspects, such as syntax, debugging, or language features. I do not allow AI tools to generate complete solutions or algorithms for me. The logic and problem-solving must be my own.

Any completion tool shouldn't be used to generate the solutions, and only the 'Ask' agent mode is allowed for chat-based tools.
...
- "Can you provide a complete solution for Day 5? Here is the problem description: ..."
- "Implement a function that solves the knapsack problem given these constraints: ..."
- ...
